...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/blog/n8n-vs-make-pymes`,                 lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/blog/cuanto-cuesta-chatbot-empresa`,     lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/blog/automatizar-facturacion-hosteleria`,lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/blog/automatizar-atencion-cliente-retail`,lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/blog/ia-para-asesorias-contables`,       lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/blog/automatizar-seguimiento-clientes`,  lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/vs-empleado`,                            lastModified: new Date(), changeFrequency: 'monthly', priority: 0.9 },
